    ...
    <View style={styles.crowdingOnTheLine}>
      ...
      <View style={styles.contentParent}>
        <View style={[styles.content, styles.contentPosition1]}>
          ...
          <View style={[styles.rectangleView, styles.contentLayout]} />
          <Image
        ...
        <Text style={[styles.tahanaout, styles.m1Layout]}>Tahanaout</Text>
      </View>
      <Image
      ...
      />
      <Text style={[styles.oumnas, styles.oumnasTypo]}>Oumnas</Text>
      <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("CROWDINGONTHELINE")}
      >
        <Text style={[styles.m1, styles.m1Layout]}>M</Text>
      </Pressable>
      <Text style={[styles.text1, styles.textTypo]}>45</Text>
      <Text style={[styles.text2, styles.textTypo]}>24</Text>
      <Pressable
        style={[styles.oumnas1, styles.mPosition]}
        onPress={() => navigation.navigate("CROWDINGONTHELINE3")}
      >
        <Text style={[styles.oumnas2, styles.oumnas2Typo]}>Oumnas</Text>
      </Pressable>
      <Text style={[styles.tameslouht, styles.oumnas2Typo]}>Tameslouht</Text>
...
export default CROWDINGONTHELINE15;
