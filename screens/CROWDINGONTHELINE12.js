...
const CROWDINGONTHELINE12 = () => {
  ...
  return (
    <View style={styles.crowdingOnTheLine}>
      ...
      <Pressable
        style={styles.epback}
        onPress={() => navigation.navigate("CROWDINGONTHELINE6")}
      >
        <Image
      ...
      <View
        style={[
          styles.crowdingOnTheLineChild1,
      ...
      >
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/iconparksolidreport7.png")}
        />
      </View>
    </View>
  );
...
export default CROWDINGONTHELINE12;
